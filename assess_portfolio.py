...
##  This script and functions assess the value of a portfolio by outputting
...
if __name__ == '__main__':    
    ...
    syms = ['SPY', 'FB', 'GLD']
    allocs = [0.4, 0.25, 0.35];
    rfr = 0.01;
    sf = 252;           #   risk free rate of return for 1 year is 1%
    gen_plot = 'ind';   #   'sum' or 'ind'
    
    cr, adr, sddr, sr = assess_portfolio(start_date, end_date, ['SPY', 'FB', 'GLD'],
